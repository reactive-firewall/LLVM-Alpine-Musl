...
if(NOT DEFINED CMAKE_SYSROOT)
  set(CMAKE_SYSROOT "" CACHE FILEPATH)
endif()

if(NOT DEFINED CMAKE_INSTALL_PREFIX)
  set(CMAKE_INSTALL_PREFIX "" CACHE FILEPATH)
endif()
...
# Try to locate clang_rt.builtins*.a (common locations + /{usr/}lib/generic)
if(NOT DEFINED CLANG_RT_PATH AND _GENERIC_MUSL_HAVE_CLANG)
  ...
  foreach(_p IN LISTS _try_paths)
    if(EXISTS "${_p}")
      file(GLOB _builtins_glob "${_p}/clang_rt.builtins*.a" "${_p}/*/clang_rt.builtins*.a")
      if(_builtins_glob)
        list(GET _builtins_glob 0 _first_builtins)
        set(CLANG_RT_PATH "${_first_builtins}" CACHE PATH "Path to clang_rt.builtins.a")
        break()
      endif()
    endif()
  endforeach()
  ...
  foreach(_d IN LISTS _search_dirs)
    if(EXISTS "${_d}")
      ...
      if(_pthreads_candidates)
        set(CMAKE_PLATFORM_HAS_PTHREADS ON CACHE BOOL)
      endif()
      file(GLOB _math_candidates "${_d}/libm.*" "${_d}/libm.so" "${_d}/libm.a")
      if(_math_candidates)
        set(CMAKE_PLATFORM_HAS_MATH_LIB ON CACHE BOOL)
      endif()
    endif()
  endforeach()
else()
...
if(_musl_loader)
  if(LD_LLD OR LD_CLANG OR LLD_LINK OR LLVM_LLD)
    set(CMAKE_PLATFORM_SUPPORTS_SHARED_LIBS ON CACHE BOOL)
  else()
    if(NOT DEFINED CMAKE_LINKER)
      set(CMAKE_PLATFORM_SUPPORTS_SHARED_LIBS OFF CACHE BOOL)
    else()
      set(CMAKE_PLATFORM_SUPPORTS_SHARED_LIBS ON CACHE BOOL)
    endif()
  endif()
